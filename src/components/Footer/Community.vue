<template>
    <div class="max-w-[330px] w-[100%]">
        <my-logo class="mb-[25px]"/>

        <p class="font-serrat font-semibold text-base text-grey mb-5">
            {{ $t("Footer.text") }}
        </p>

        <h2 class="font-serrat font-semibold text-base text-grey mb-[15px]">
            {{ $t("Footer.community") }}
        </h2>
